...
define nginx_vhost (
  ...
  nginx::resource::location { "${server_name}-app":
    ensure              => present,
    vhost               => $server_name,
    location            => '^~ /app/',
    proxy               => undef,
  ...
  nginx::resource::location { "${server_name}-includes":
    ensure              => present,
    vhost               => $server_name,
    location            => '^~ /includes/',
    proxy               => undef,
  ...
  nginx::resource::location { "${server_name}-lib":
    ensure              => present,
    vhost               => $server_name,
    location            => '^~ /lib/',
    proxy               => undef,
  ...
  nginx::resource::location { "${server_name}-media-downloadable":
    ensure              => present,
    vhost               => $server_name,
  ...
  nginx::resource::location { "${server_name}-pkginfo":
    ensure              => present,
    vhost               => $server_name,
    location            => '^~ /pkginfo/',
    proxy               => undef,
  ...
  nginx::resource::location { "${server_name}-report-config":
    ensure              => present,
    vhost               => $server_name,
  ...
  nginx::resource::location { "${server_name}-var":
    ensure              => present,
    vhost               => $server_name,
    location            => '^~ /var/',
    proxy               => undef,
  ...
  nginx::resource::location { "${server_name}-export-folder":
    ensure              => present,
    vhost               => $server_name,
    location            => '/var/export/',
    proxy               => undef,
  ...
  nginx::resource::location { "${server_name}-disable-hidden":
    ensure              => present,
    vhost               => $server_name,
    location            => '/.',
    proxy               => undef,
  ...
  nginx::resource::location { "${server_name}-common-front":
    ensure              => present,
    vhost               => $server_name,
    location            => '@handler',
    proxy               => undef,
    try_files           => undef,
    www_root            => undef,
    location_custom_cfg => { 'rewrite' => '/ /index.php' },
    notify              => Class['nginx::service'],
  }

  nginx::resource::location { "${server_name}-forward":
    ensure              => present,
    vhost               => $server_name,
    location            => '~ .php/',
    proxy               => undef,
    try_files           => undef,
    www_root            => undef,
    location_custom_cfg => { 'rewrite' => '^(.*.php)/ $1 last' },
    notify              => Class['nginx::service'],
  }
